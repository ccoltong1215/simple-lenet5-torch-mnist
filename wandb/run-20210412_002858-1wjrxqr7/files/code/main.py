...
def main():
    ...
    optimizerLeNet = torch.optim.SGD(LeNet5_model.parameters(), lr=0.0001, momentum=0.9)

    LeNet5_regulized_model = LeNet5_regulized()
    criterionLeNet_regulized = torch.nn.CrossEntropyLoss()
    optimizerLeNet_regulized = torch.optim.SGD(LeNet5_regulized_model.parameters(), lr=0.0001, momentum=0.9,weight_decay=0.1) ## L2 regularization

    CustomMLP_model = CustomMLP()
    criterionCustomMLP = torch.nn.CrossEntropyLoss()
    optimizerCustomMLP = torch.optim.SGD(CustomMLP_model.parameters(), lr=0.0001, momentum=0.9)
